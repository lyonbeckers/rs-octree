...
fn from_iter() {
    ...
    let mut oct_a: Octree<i32, TileData> = Octree::new(AABB::from_extents(Point::zeros(), Point::zeros()), DEFAULT_MAX);
...
fn serialize_deserialize() {
    ...
    let mut octree = Octree::<i32, TileData>::new(AABB::from_extents(Point::new(-5,-5,-5), Point::new(5,5,5)), DEFAULT_MAX);
